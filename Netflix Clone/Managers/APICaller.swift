...
class APICaller {
    ...
    func getTrendingMovies(completion: @escaping (Result<[Movie], APIEror>)-> Void) {
    ...
    func getTrendingTVs(completion: @escaping (Result<[TV], APIEror>)-> Void) {
    ...
    func getUpcomingMovies(completion: @escaping (Result<[Movie], APIEror>)-> Void) {
    ...
    func getPopular(completion: @escaping (Result<[Movie], APIEror>)-> Void) {
    ...
    func getTopRated(completion: @escaping (Result<[Movie], APIEror>)-> Void) {
